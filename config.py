...
class Config(object):
    """
    Improved Configuration class with proper validation and error handling
    """
...
{chr(10).join(f'export {var}="your_value_here"' for var in missing_vars)}
            """
    ...
    MAX_FILE_SIZE = int(get_env_var.__func__("MAX_FILE_SIZE", required=False, default="2147483648"))  # 2GB default
